...
import { Eye, Edit3, RefreshCw, Brain, Sparkles } from "lucide-react";
...
export default function MemoryPage() {
  const [activeTab, setActiveTab] = useState<MemoryTab>("files");
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ padding: "24px 24px 16px 24px", flexShrink: 0 }}>
        ...
        <p style={{ fontFamily: "var(--font-body)", fontSize: "13px", color: "var(--text-secondary)" }}>
          Explora los archivos de memoria y la memoria vectorial semántica
        </p>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            color: activeTab === "files" ? "var(--bg, #111)" : "var(--text-secondary)",
            border: "none",
        ...
        <button
          ...
          style={{
            ...
            gap: "8px",
            padding: "10px 20px",
            backgroundColor: activeTab === "vector" ? "var(--accent)" : "transparent",
            color: activeTab === "vector" ? "var(--bg, #111)" : "var(--text-secondary)",
            border: "none",
            borderBottom: activeTab === "vector" ? "2px solid var(--accent)" : "2px solid transparent",
            borderRadius: "8px 8px 0 0",
            cursor: "pointer",
            fontSize: "13px",
            fontWeight: 600,
